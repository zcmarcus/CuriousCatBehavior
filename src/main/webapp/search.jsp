            ...
            <div class="col-9 offset-1">
                <c:choose>
                    <c:when test="${empty matchingPosts}">
                        <h3 class="mb-3"><span class="font-weight-bold text-error">0</span> posts matching term: ${searchTerm} </h3>


                    </c:when>
                    <c:otherwise>
                    <h3 class="mb-3">Displaying posts matching term: ${searchTerm} </h3>
